...
<%
	...
	ArrayList<RankListDto> list = (ArrayList<RankListDto>)request.getAttribute("list");
%>
...
<section>
	<table>
		<caption>참가자등수 조회</caption>
		<tr>
			<td class="main">참가자ID</td>
			<td class="main">참가자이름</td>
			<td class="main">종합점수</td>
			<td class="main">평균점수점수</td>
			<td class="main">순위</td>
		</tr>
